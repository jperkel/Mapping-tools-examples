...
These examples were created for a Nature Toolbox article by Jeffrey Perkel, published 7 June 2018. The Leaflet library produces interactive maps that allow users to pan, zoom, and click on points of interest.  
...
base_path <- "/Users/jeffreyperkel/Downloads/al112017_5day_020/"

# Import the advisory 'shape' files...
irmaPolygon <- readOGR(paste(base_path, "al112017-020_5day_pgn.shp", sep = ""))
irmaLine <- readOGR(paste(base_path, "al112017-020_5day_lin.shp", sep = ""))
irmaPoints <- readOGR(paste (base_path, "al112017-020_5day_pts.shp", sep = ""))
```
